...
public class QuerryAction8 extends SimpleCommand {

    RebuildFulltextSearchIndexAction.GetCurrentLibraryTab currentLibraryTab;

    public QuerryAction8(RebuildFulltextSearchIndexAction.GetCurrentLibraryTab aux) {
    ...
    public void execute() {
        ...
        JLabel logo  = new JLabel("Query - Topics by Author");
